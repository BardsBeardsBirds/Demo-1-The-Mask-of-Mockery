...
public class ThirdPersonCamera : MonoBehaviour 
{
    ...
    public GameObject IntroDialoguePosition;
	...
	void Start () 
	{
        ...
        {
            ThirdPersonCamera.Instance.CameraToIntroPosition(GameManager.IntroDialogue[4000]);
        }
        ...
        if(IntroDialoguePosition == null)
        {
            Debug.Log("Please assign an intro dialogue position");
        }
    }
    ...
    public void CameraToIntroPosition(SpokenLine spokenLine)
    {
        _freezeCamera = true;
        Debug.Log(_camera.transform.position);
        IntroDialoguePosition.GetComponent<DialogueCamera>().FindAngle(_camera, spokenLine);
    }
