    ...
    private static void FindInteractionLines(ObjectsInLevel objectInLevel)
    {
        switch (objectInLevel)
        {
            ...
            case ObjectsInLevel.MaskOfMockery:
                ...
                //force move clown, because he changes position for some reason
                GameManager.NPCs[Character.Benny].transform.parent.transform.localPosition = new Vector3(-33.48f, -0.087f, -23.32f);
                Debug.LogWarning("moved benny");
                break;
            case ObjectsInLevel.Wheel1:
